...
namespace Login
{
    public partial class EDIT_FILM_3 : Form
    {
        private Menu edit3; // Menyimpan referensi form Menu

        // Konstruktor dengan parameter Menu
        public EDIT_FILM_3(Menu edit3)
        {
            InitializeComponent();
            this.edit3 = edit3; // Menyimpan referensi form Menu
        }

        private void EDIT_FILM_3_Load(object sender, EventArgs e)
        {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            edit3.UpdateFilmInfo3(judul, durasi, sutradara, genre);
            edit3.UpdateNorthmanPicture(gambar);
